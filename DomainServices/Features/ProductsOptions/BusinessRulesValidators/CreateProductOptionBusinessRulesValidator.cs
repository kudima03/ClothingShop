...
public class CreateProductOptionBusinessRulesValidator : IBusinessRulesValidator<CreateCommand<ProductOption>>
{
    private readonly IRepository<ProductColor> _productColorsRepository;
    private readonly IRepository<Product> _productsRepository;

    public CreateProductOptionBusinessRulesValidator(IRepository<Product> productsRepository,
    ...
    public async Task ValidateAsync(CreateCommand<ProductOption> entity, CancellationToken cancellation = default)
    {

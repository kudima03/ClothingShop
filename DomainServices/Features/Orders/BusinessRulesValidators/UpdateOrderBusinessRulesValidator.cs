...
public class UpdateOrderBusinessRulesValidator : IBusinessRulesValidator<UpdateCommand<Order>>
{
    private readonly IRepository<OrderStatus> _orderStatusesRepository;

    private readonly IRepository<User> _usersRepository;

    public UpdateOrderBusinessRulesValidator(IRepository<OrderStatus> orderStatusesRepository,
    ...
    public async Task ValidateAsync(UpdateCommand<Order> entity, CancellationToken cancellation = default)
    {

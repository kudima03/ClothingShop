...
public class ProductsController(IMediator mediator) : Controller
{
    ...
    public async Task<ActionResult<IEnumerable<Product>>> GetAllProducts(CancellationToken cancellationToken)
    {
        ...
        IEnumerable<Product> products = await mediator.Send(query, cancellationToken);
    ...
    public async Task<ActionResult<Product>> GetProductById([FromRoute] long id, CancellationToken cancellationToken)
    {
        ...
        Product product = await mediator.Send(query, cancellationToken);
                                                                                  ...
                                                                                  CancellationToken cancellationToken)
    {
        ...
        IEnumerable<Product> product = await mediator.Send(query, cancellationToken);
    ...
    public async Task<ActionResult> CreateProduct([FromBody] CreateProductCommand createCommand,
                                                  CancellationToken cancellationToken)
    {
        Product createdProduct = await mediator.Send(createCommand, cancellationToken);

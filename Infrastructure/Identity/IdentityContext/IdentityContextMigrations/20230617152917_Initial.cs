...
namespace Infrastructure.Identity.IdentityContext.IdentityContextMigrations;
        ...
        migrationBuilder.CreateTable
            ("AspNetUsers",
             table => new
             {
                 ...
                 DeletionDateTime = table.Column<DateTime>("timestamp with time zone", nullable: true),

...
public partial class ColorEntityRemoved : Migration
{
    ...
    {
        migrationBuilder.DropForeignKey("FK_product_colors_colors_id",
                                        "product_colors");

        migrationBuilder.DropTable("colors");

        migrationBuilder.DropColumn("color_id",
                                    "product_colors");
        ...
        migrationBuilder.AddColumn<string>("color_hex",
                                           "product_colors",
                                           "text",
                                           nullable: false,
                                           defaultValue: "");
    ...
    {
        migrationBuilder.DropColumn("color_hex",
                                    "product_colors");
        ...
        migrationBuilder.AddColumn<long>("color_id",
                                         "product_colors",
                                         "bigint",
                                         nullable: false,
                                         defaultValue: 0L);
        ...
        migrationBuilder.AddForeignKey("FK_product_colors_colors_id",
                                       "product_colors",
                                       "id",
                                       "colors",
                                       principalColumn: "id",

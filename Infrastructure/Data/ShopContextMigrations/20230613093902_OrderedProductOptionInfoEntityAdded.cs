...
public partial class OrderedProductOptionInfoEntityAdded : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable("order_product_options",
                                     table => new
                                     {
                                     ...
                                     constraints: table =>
                                     {
                                         ...
                                         table.ForeignKey("FK_order_product_options_order_order_id",
                                                          x => x.order_id,
                                                          "order",
                                                          "id",
                                                          onDelete: ReferentialAction.Cascade);

                                         table.ForeignKey("FK_order_product_options_product_option_product_option_id",
        ...
        migrationBuilder.CreateIndex("IX_order_product_options_order_id",
                                     "order_product_options",
                                     "order_id");

        migrationBuilder.CreateIndex("IX_order_product_options_product_option_id",
                                     "order_product_options",
                                     "product_option_id");
    }
    ...
    {
        migrationBuilder.DropTable("order_product_options");

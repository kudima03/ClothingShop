...
public partial class Initial : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable
            ("sections_categories",
             ...
             constraints: table =>
             {
                 ...
                 table.ForeignKey
                     ("FK_sections_categories_categories_category_id",
                      x => x.category_id,
                      "categories",
                      "id",
                      onDelete: ReferentialAction.Cascade);
                 ...
                 table.ForeignKey
                     ("FK_sections_categories_sections_section_id",
                      x => x.section_id,
                      "sections",
                      "id",
                      onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable
            ("products",
             ...
             constraints: table =>
             {
                 ...
                 table.ForeignKey
                     ("FK_products_subcategories_subcategory_id",
                      x => x.subcategory_id,
                      "subcategories",
                      "id",
                      onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateTable
            ("images_urls",
             ...
             constraints: table =>
             {
                 ...
                 table.ForeignKey
                     ("FK_images_urls_product_colors_product_color_id",
        ...
        migrationBuilder.CreateTable
            ("reviews",
             ...
             constraints: table =>
             {
                 ...
                 table.ForeignKey
                     ("FK_reviews_products_product_id",
                      x => x.product_id,
                      "products",
                      "id",
                      onDelete: ReferentialAction.Cascade);
        ...
        migrationBuilder.CreateIndex
            ("IX_images_urls_product_color_id",
             "images_urls",
             "product_color_id");
        ...
        migrationBuilder.CreateIndex
            ("IX_sections_categories_section_id",
             "sections_categories",
             "section_id");
